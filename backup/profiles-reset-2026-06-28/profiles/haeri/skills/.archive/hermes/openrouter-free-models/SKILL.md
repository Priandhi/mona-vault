...
description: Discover, test, and configure free OpenRouter models as Hermes Agent providers. Covers model discovery, quality testing, config.yaml custom_providers setup, and model routing (primary/auxiliary/delegation).
triggers:
  - user asks for free models or cheapest LLM options
  - user wants to add OpenRouter models to Hermes
  - user wants to switch primary model provider
  - user asks about NVIDIA Nemotron, Qwen, Gemma, or other free models
  - user asks for best newest model
---
