> **Source**: This file was migrated from the `github-code-review` skill (consolidated into `github-workflows` on June 2026). The original skill has been archived. Edit here, not in `.archive/`.
