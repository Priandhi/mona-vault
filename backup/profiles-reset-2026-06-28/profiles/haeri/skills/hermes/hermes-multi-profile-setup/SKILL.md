...
- `claude-code-mimo-setup` → `references/claude-code-mimo-setup.md` + `references/mimo-claudecode-docs.md`. Reason: about provider config for Claude Code + MiMo API — same domain as multi-profile provider setup.
