...
- **OpenRouter free models** — Discover and configure free OpenRouter models as Hermes providers. See `references/openrouter-free-models.md` (migrated from `openrouter-free-models`).
