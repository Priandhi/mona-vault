...
The following skills were merged into this umbrella. Their unique content is preserved as references.

- `crypto-data-scrapers` → `references/crypto-data-scrapers-absorbed.md` (DEXScreener/DeFiLlama/CoinGlass APIs)
  - Plus `references/cpu-mining-reference-cds.md` (Juno Cash mining notes that lived there)
- `alpha-hunter-new-token-discovery` → `references/alpha-hunter-new-token-discovery-absorbed.md` (new token scanners: DEXScreener, Jupiter, gmgn)
  - `references/alpha-hunter-api-examples.md`, `references/alpha-hunter-sniper-monitor.md`, `references/alpha-hunter-browser-scraping.md`
- `galxe-reverse-engineering` → `references/galxe-reverse-engineering-absorbed.md` (Galxe quest/GraphQL schema)
  - `references/galxe-gql-schema-gre.md`
- `gandalf-level-8` → `references/gandalf-level-8-absorbed.md` (Lakera Gandalf prompt-injection CTF — also see `ctf-prompt-injection-notes.md`)
  - `references/lakera-gandalf-full-session.md`
- `web3-game-bypass-recon` → `references/web3-game-bypass-recon-absorbed.md` (Web3 game recon + token-gate bypass)
  - `references/web3-game-bypass-owntown-case.md`
- `vps-mining-setup` → `references/vps-mining-setup-absorbed.md` (Juno/RandomX VPS mining, Telegram monitoring)
  - `references/juno-pool-mining-vms.md`, `references/twitter-access-patterns-vms.md`
- `gpu-cloud-mining` → `references/gpu-cloud-mining-absorbed.md` (Modal serverless GPU mining)
  - `references/gpu-miner-debugging-gcm.md`, `references/keryx-miner-setup-gcm.md`, `references/modal-gpu-pricing-gcm.md`
  - `scripts/modal-watchdog.sh`, `templates/modal-gpu-miner.py`, `templates/modal-prebuilt-solo-miner.py`
