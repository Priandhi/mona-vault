---
name: iclix-anti-ads-direct-play
description: Custom HLS video player for ICLIX that bypasses iframe ads by scraping m3u8 from VidLink/VidSrc via headless Chromium and playing through backend stream proxy.
---
