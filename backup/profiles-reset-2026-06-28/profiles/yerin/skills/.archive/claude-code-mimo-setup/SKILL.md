---
name: claude-code-mimo-setup
description: Setup Claude Code CLI with Xiaomi MiMo API (cheaper alternative to Anthropic). Pay-as-you-go or Token Plan.
tags: [claude-code, mimo, xiaomi, coding-agent, api]
---
